...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-[#E7D5B1]">
      {/* Barra lateral */}
      <div className="bg-white shadow-xl w-full md:w-1/4 h-full left-0 md:left-0 top-0 md:top-0 absolute rounded-lg overflow-hidden">
        <div className="p-1 flex">
          <div>
            <img
              src={logoImage}
              alt="Logo"
              className="w-full h-28 md:h-44 mr-2 md:mr-23"
            />
          </div>
          <div className="flex items-center">
            <h1 className="absolute left-2 md:left-32 mr-1/2 text-xl md:text-2xl font-bold text-black font-boogaloo">
        ...
        <nav className="p-2">
          <ul>
            <li>
              <Link
                to="/dashboard"
                className="text-black hover:bg-green-500 hover:bg-opacity-30 py-2 md:py-3 px-4 md:block rounded uppercase text-center font-boogaloo text-xl md:text-2xl"
              >
                Inicio
              </Link>
            </li>
            <li>
              <Link
                ...
                className="text-black uppercase text-center hover:bg-green-500 hover:bg-opacity-30 py-2 md:py-3 rounded px-4 md:block font-boogaloo text-xl md:text-2xl"
              >
                Frutas
              </Link>
            </li>
        ...
        <div className="absolute top-2/3 left-1/4 md:left-1/6 flex items-center justify-end pr-4">
          {isLoggedIn && (
            <>
              <div className="flex items-center flex-col">
                <img
                  ...
                  className="w-20 h-16 md:w-26 md:h-20 mb-1"
                />
                <span className="font-boogaloo text-black text-md md:text-xl mr-2">
                  {usuario}
                </span>
                <button
                  onClick={handleLogout}
                  className="bg-red-500 text-white py-2 px-4 rounded-md mt-2 text-sm md:text-base"
                >
                  Cerrar sesión
                </button>
              </div>
      ...
      {/* Contenido principal */}
      <div className="flex-1 overflow-x-hidden overflow-y-auto mt-32 md:mt-0">
